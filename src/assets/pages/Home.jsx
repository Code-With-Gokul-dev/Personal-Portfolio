                        ...
                        <div className="border-t border-line w-full flex flex-col">
                            ...
                            <div className="h-auto sm:h-14 border-t border-line py-3 sm:py-2 flex flex-col sm:flex-row items-center sm:justify-between px-4 sm:pl-4 sm:pr-4 gap-3 sm:gap-0 w-full">
                                ...
                                <div className="flex items-center gap-2 shrink-0">
                                    <button onClick={() => setIsResumeOpen(true)} className="inline-flex items-center gap-2 px-4 py-1.5 text-xs font-medium bg-foreground text-background border border-transparent rounded-lg hover:bg-foreground/90 transition-colors" aria-label="Open Resume Document">
